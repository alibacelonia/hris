                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Department of the Interior and Local Government" name="we_agency1">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>Position<sup class="text-danger"></sup></label>
                                                    <input type="text" class="form-control" placeholder="Year" name="we_position1" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>From<sup class="text-danger"></sup></label>
                                                    <input onfocus="(this.type='date')" onblur="(this.type='text')"  class="form-control" placeholder="month/year" name="we_from1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>To<sup class="text-danger"></sup></label>
                                                    <input onfocus="(this.type='date')" onblur="(this.type='text')"  class="form-control" placeholder="" name="we_to1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="" name="we_salary1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Company/Agency<sup class="text-danger"></sup></label>
                                                    <input type="text" class="form-control" placeholder="Department of the Interior and Local Government" name="we_agency2">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>Position<sup class="text-danger"></sup></label>
                                                    <input type="text" class="form-control" placeholder="Year" name="we_position2">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>From<sup class="text-danger"></sup></label>
                                                    <input onfocus="(this.type='date')" onblur="(this.type='text')"  class="form-control" placeholder="month/year" name="we_from2">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>To<sup class="text-danger"></sup></label>
                                                    <input onfocus="(this.type='date')" onblur="(this.type='text')"  class="form-control" placeholder="" name="we_to2">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>Monthly Salary<sup class="text-danger"></sup></label>
                                                    <input type="number" class="form-control" placeholder="" name="we_salary2">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Company/Agency<sup class="text-danger"></sup></label>
                                                    <input type="text" class="form-control" placeholder="Department of the Interior and Local Government" name="we_agency3">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>Position<sup class="text-danger"></sup></label>
                                                    <input type="text" class="form-control" placeholder="Year" name="we_position3">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>From<sup class="text-danger"></sup></label>
                                                    <input onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" placeholder="month/year" name="we_from3">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>To<sup class="text-danger"></sup></label>
                                                    <input onfocus="(this.type='date')" onblur="(this.type='text')"  class="form-control" placeholder="" name="we_to3">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>Monthly Salary<sup class="text-danger"></sup></label>
                                                    <input type="number" class="form-control" placeholder="" name="we_salary3">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Company/Agency<sup class="text-danger"></sup></label>
                                                    <input type="text" class="form-control" placeholder="Department of the Interior and Local Government" name="we_agency4">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>Position<sup class="text-danger"></sup></label>
                                                    <input type="text" class="form-control" placeholder="Year" name="we_position4">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>From<sup class="text-danger"></sup></label>
                                                    <input onfocus="(this.type='date')" onblur="(this.type='text')"  class="form-control" placeholder="month/year" name="we_from4">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>To<sup class="text-danger"></sup></label>
                                                    <input onfocus="(this.type='date')" onblur="(this.type='text')"  class="form-control" placeholder="" name="we_to4">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <label>Monthly Salary<sup class="text-danger"></sup></label>
                                                    <input type="number" class="form-control" placeholder="" name="we_salary4">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
